...
new_review = 'খারাপ সিনেমা'
new_review = re.sub('[^অ-ঔক-য়]', ' ', new_review)
new_review = new_review.lower()
new_review = new_review.split()
new_review = [stmr.stem(word) for word in new_review if not word in set(all_stopwords)]
